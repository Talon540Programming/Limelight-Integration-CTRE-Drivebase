...
public class CommandSwerveDrivetrain extends SwerveDrivetrain<TalonFX, TalonFX, CANcoder> implements Subsystem {
    ...
    /* SysId routine for characterizing rotation. This is used to find PID gains for the rotation. */
    ...
    public CommandSwerveDrivetrain(
        ...
        super(TalonFX::new, TalonFX::new, CANcoder::new, drivetrainConstants, 0.0,
            odometryStandardDeviation, visionStandardDeviation, modules);
        if (RobotBase.isSimulation()) {
            startSimThread();
        }
