...
public class RobotContainer {
  ...
  private VisionIOLimelight vision = new VisionIOLimelight();
  //will pass in the drive base with the autogenerated code
  private ReefCentering reefCentering = new ReefCentering(drivetrain);
  private CommandSwerveDrivetrain drivetrain = new CommandSwerveDrivetrain();
